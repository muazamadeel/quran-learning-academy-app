...
/// @nodoc
mixin _$UpcomingClassModel {

 String get id; String get studentName; String get studentImage; String get time; String get subject; String get status;
/// Create a copy of UpcomingClassModel
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$UpcomingClassModelCopyWith<UpcomingClassModel> get copyWith => _$UpcomingClassModelCopyWithImpl<UpcomingClassModel>(this as UpcomingClassModel, _$identity);

  /// Serializes this UpcomingClassModel to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UpcomingClassModel&&(identical(other.id, id) || other.id == id)&&(identical(other.studentName, studentName) || other.studentName == studentName)&&(identical(other.studentImage, studentImage) || other.studentImage == studentImage)&&(identical(other.time, time) || other.time == time)&&(identical(other.subject, subject) || other.subject == subject)&&(identical(other.status, status) || other.status == status));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,studentName,studentImage,time,subject,status);

@override
String toString() {
  return 'UpcomingClassModel(id: $id, studentName: $studentName, studentImage: $studentImage, time: $time, subject: $subject, status: $status)';
}
...
/// @nodoc
abstract mixin class $UpcomingClassModelCopyWith<$Res>  {
  factory $UpcomingClassModelCopyWith(UpcomingClassModel value, $Res Function(UpcomingClassModel) _then) = _$UpcomingClassModelCopyWithImpl;
@useResult
$Res call({
 String id, String studentName, String studentImage, String time, String subject, String status
});
...
/// @nodoc
class _$UpcomingClassModelCopyWithImpl<$Res>
    implements $UpcomingClassModelCopyWith<$Res> {
  _$UpcomingClassModelCopyWithImpl(this._self, this._then);

  final UpcomingClassModel _self;
  final $Res Function(UpcomingClassModel) _then;

/// Create a copy of UpcomingClassModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? studentName = null,Object? studentImage = null,Object? time = null,Object? subject = null,Object? status = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
/// Adds pattern-matching-related methods to [UpcomingClassModel].
extension UpcomingClassModelPatterns on UpcomingClassModel {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _UpcomingClassModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _UpcomingClassModel() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _UpcomingClassModel value)  $default,){
final _that = this;
switch (_that) {
case _UpcomingClassModel():
return $default(_that);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _UpcomingClassModel value)?  $default,){
final _that = this;
switch (_that) {
case _UpcomingClassModel() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String studentName,  String studentImage,  String time,  String subject,  String status)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UpcomingClassModel() when $default != null:
return $default(_that.id,_that.studentName,_that.studentImage,_that.time,_that.subject,_that.status);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String studentName,  String studentImage,  String time,  String subject,  String status)  $default,) {final _that = this;
switch (_that) {
case _UpcomingClassModel():
return $default(_that.id,_that.studentName,_that.studentImage,_that.time,_that.subject,_that.status);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String studentName,  String studentImage,  String time,  String subject,  String status)?  $default,) {final _that = this;
switch (_that) {
case _UpcomingClassModel() when $default != null:
return $default(_that.id,_that.studentName,_that.studentImage,_that.time,_that.subject,_that.status);case _:
  return null;
...
class _UpcomingClassModel implements UpcomingClassModel {
  const _UpcomingClassModel({required this.id, required this.studentName, required this.studentImage, required this.time, required this.subject, this.status = 'upcoming'});
  factory _UpcomingClassModel.fromJson(Map<String, dynamic> json) => _$UpcomingClassModelFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$UpcomingClassModelCopyWith<_UpcomingClassModel> get copyWith => __$UpcomingClassModelCopyWithImpl<_UpcomingClassModel>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$UpcomingClassModelToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _UpcomingClassModel&&(identical(other.id, id) || other.id == id)&&(identical(other.studentName, studentName) || other.studentName == studentName)&&(identical(other.studentImage, studentImage) || other.studentImage == studentImage)&&(identical(other.time, time) || other.time == time)&&(identical(other.subject, subject) || other.subject == subject)&&(identical(other.status, status) || other.status == status));
}
...
/// @nodoc
abstract mixin class _$UpcomingClassModelCopyWith<$Res> implements $UpcomingClassModelCopyWith<$Res> {
  factory _$UpcomingClassModelCopyWith(_UpcomingClassModel value, $Res Function(_UpcomingClassModel) _then) = __$UpcomingClassModelCopyWithImpl;
@override @useResult
$Res call({
 String id, String studentName, String studentImage, String time, String subject, String status
});
...
/// @nodoc
class __$UpcomingClassModelCopyWithImpl<$Res>
    implements _$UpcomingClassModelCopyWith<$Res> {
  __$UpcomingClassModelCopyWithImpl(this._self, this._then);

  final _UpcomingClassModel _self;
  final $Res Function(_UpcomingClassModel) _then;

/// Create a copy of UpcomingClassModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? studentName = null,Object? studentImage = null,Object? time = null,Object? subject = null,Object? status = null,}) {
  return _then(_UpcomingClassModel(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,studentName: null == studentName ? _self.studentName : studentName // ignore: cast_nullable_to_non_nullable
as String,studentImage: null == studentImage ? _self.studentImage : studentImage // ignore: cast_nullable_to_non_nullable
as String,time: null == time ? _self.time : time // ignore: cast_nullable_to_non_nullable
